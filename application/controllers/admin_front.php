...
class Admin_front extends Admin_content {
  ...
  public function _start()
  {
    ...
    //set the primary key
    $this->_setAdmin_user_key('slide_id');

    //set the page
    $this->_setAdmin_user_page('admin_front');

    //set the data model
    $this->_setAdmin_user_model($this->_getBoot_name() . 'slide');
